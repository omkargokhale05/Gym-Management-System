...
Public Class RptHealthCheckUp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_Management_System.RptHealthCheckUp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHealthCheckUp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHealthCheckUp = New RptHealthCheckUp
        rpt.Site = Me.Site
        Return rpt
    End Function
