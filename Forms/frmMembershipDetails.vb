...
#End Region
    ...
    Private Sub dgMembershipDetails_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgMembershipDetails.CellContentClick
    ...
    Private Sub cmbPaymentMode_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPaymentMode.SelectedIndexChanged
        Dim a As String
        a = cmbPaymentMode.Text
        If a = "Cash" Then
            txtBankName.ReadOnly = True
            txtCheqckNo.ReadOnly = True
        End If
    End Sub
End Class